...
function DngConverter:convertPhoto( photo, dngPath, addlOptions, metadataCache )
    ...
    addlOptions = addlOptions or  "-cr7.1 -dng1.3 -p0" -- Note: camera raw version is necessary to avoid UI, however dng version is not - but I don't feel comfortable creating 1.4 dngs until new command-line options are documented ###1.
...
function DngConverter:convertToDng( params )
    ...
    if str:is( addlOptions ) then
        ...
        addlOptions = "-cr7.1 -dng1.3 -p0" -- Note: camera raw version is necessary to avoid UI, however dng version is not - but I don't feel comfortable creating 1.4 dngs until new command-line options are documented ###1.
    end
