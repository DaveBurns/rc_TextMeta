...
function Gui:gridMode( mandatory )
    ...
    elseif not mandatory then
        ...
        repeat
            local btn = app:show{ info="Unable to switch automatically to ^1 grid mode of library module, which is mandatory for operation to succeed. If already in grid mode, just click 'Already in Grid Mode', otherwise click 'Dismiss dialog for 3 seconds' button, and switch to grid mode manually.",
                subs = { Gui.moduleNames[moduleNumber] },
