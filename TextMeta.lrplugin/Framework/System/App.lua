...
--
function App:getPref( name, presetName, expectedType ) -- , defaultValue )
    ...
    if rawValue == nil then
        -- return defaultValue -- may also be nil.
        return nil -- I think default handling shall remain in calling context for now.
    end
